import { defineComponent, reactive, PropType, ExtractPropTypes } from 'vue';
import { useMergedColor } from '../../hooks/useMergedColor';
...
export type BorderBox1Props = ExtractPropTypes<ReturnType<typeof borderBox1Props>>;
...
export const BorderBox1 = /*#__PURE__*/ withInstall(
  defineComponent({
    ...
    setup(props, { slots }) {
      const { color, backgroundColor } = reactive(props);
      const mergedColor = useMergedColor(defaultColor, color);
...
export const Test = <BorderBox1 style={{ width: '100%', height: '300px' }}>123</BorderBox1>;
